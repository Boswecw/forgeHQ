...
ASSEMBLED_OUTPUT="${1:-$ROOT_DIR/doc/FRGSYSTEM.md}"
...
require_contains "$PARTS_DIR/_index.md" "**Designation:** FRG" "index designation"
require_contains "$PARTS_DIR/_index.md" "BDS Documentation Protocol v2.0" "index protocol"
require_contains "$PARTS_DIR/_index.md" 'Primary output: `doc/FRGSYSTEM.md`' "index primary output"
require_contains "$PARTS_DIR/BUILD.sh" 'DESIGNATION="FRG"' "build designation"
...
require_contains "$ASSEMBLED_OUTPUT" "**Designation:** FRG" "assembled designation"
require_contains "$ASSEMBLED_OUTPUT" 'Primary output: `doc/FRGSYSTEM.md`' "assembled primary output"
