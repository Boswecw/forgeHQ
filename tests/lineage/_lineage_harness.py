"""Mock-transport harness for forgeHQ emitter tests.

Same pattern as the ForgeMath harness — both repos use top-level ``app`` and
collide with dataforge-Local. We record outbound requests against an httpx
MockTransport instead.
"""
